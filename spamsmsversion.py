...
\033[1;97m                          ╚══════╦══════╩════════════════════╩═════╦══════╝
\033[1;97m                #╔═══════════════╩═════════════════════════════════╩═════════════════╗#
\033[1;97m                #║]================ [ Welcome Spam Sms Version 1 ] =================[║#
\033[1;39m                #║ - - - - - -- - - -[ BQK.x.SMS Spam Panel 2022 ]- - - - - - - - - -║#
\033[1;39m                #║══════════════════>> Bùi Quang Khải Profile :                      ║#  
\033[1;39m                #║FB Bùi Quang Khải : https://www.facebook.com/buiquangkhai.user4    ║# 
\033[1;39m                #║Zalo Quang Khải : 0352876128                                       ║#  
\033[1;39m                #║Thông tin cá nhân xem tại : https://subngon.tokyo/                 ║#  
\033[1;39m                #║                                                                    ║#  
\033[1;39m                #║ ═════════════════════════════════════════════════════════════════ ║#  
\033[1;39m                #║ ════> Nhận all kèo, học viên dame, unlock facebook, nhận code web ║#  
\033[1;39m                #║thông tin cá nhân, bán tool ddos, botnet,setup botnet, code tool   ║#  
\033[1;39m                #║theo yêu cầu, thiết kế website, chỉnh sửa giấy tờ tùy thân         ║#  
\033[1;39m                #╚═══════════════════════════════════════════════════════════════════╝#  
\033[1;39m © Code by BuiQuangKhai
                               \n\n'''
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"NHẬP SỐ ĐIỆN THOẠI SPAM CHẾT CỤ NÓ: "))
            if self.phone != '0346720407':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0346720407':
                print(self.format_print("!", "MẤY THẰNG MẶT CẶC SPAM SỐ ADMIN AHH BAND HẾT GIỜ"))
            time.sleep(3)
...
if __name__ == "__main__":
    try:
        ...
        time.sleep(3)
        sys.exit('\n'+SPAM().format_print('*', 'BuiQuangKhai:)'))
